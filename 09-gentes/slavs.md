...
- **См.** `carpitoslavi.md` **(«**горная** **линия**» **Славии, тиверцы** **+** **уличи** **+** **Галицкие** **хорваты** **+** **лемки**/**бойки**/**гуцулы**/**русины** — 2000 лет карпатской идентичности)**.
...
- **См.** `carpitoslavi.md` **(полное** **досье** — 820 строк, 10 разделов, ИСТОЧНИКИ)**.

**См. также** `slavjane.md`, `moravia-magna.md`, `bulgaria-prima.md`, `slavica-xix.md`, `brizinski-spomenici.md`, `methodius-abc.md`, `carpitoslavi.md` **(новая** **«**горная**»** **ветвь** **Славии** — тиверцы, уличи, лемки, бойки, гуцулы, русины)**.
