...
**Datum: 021.M3 · обновлён в рамках ревизии 021.M3 (4 печати, CREDO-файл, CONCORDANTIA)**
...
| `05-probatio/damnata.md` (стегозавр) | ✠ DAMNATUS | оставляю за собой право на любопытство |
| `00/hypothesa-corporis.md` (casus Isa) | «редакционная претензия» | формулировка корректна, но недостаточна; мусульмане тоже несут корпус |
| Все славянские/православные досье | ◆/◇ архивные | славянский перекос осознан, частично обоснован, частично уязвим |
